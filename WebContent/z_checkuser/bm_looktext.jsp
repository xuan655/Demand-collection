                ...
                %>
                    <table class="insert-tab" width="100%">
                        <tbody>
                          ...
                          <form action="bm_check?id=<%=text.get(0).getId() %>" method="post" id="myform" name="myform">
                             <th colspan="1">部门审核意见:</th>
                                 <td colspan="3">
                                   <input type="text" class="common-text required" size="100px" id="bmyj" name="bmyj" required="required" >
