			...
			<div class="sidebar-content">
				<ul class="sidebar-list">
					<li><a href="#"><i class="icon-font">&#xe003;</i>常用操作</a>
						<ul class="sub-menu">
						    <li><a href="../A_selecttext" target="operation"><i class="icon-font">&#xe008;</i>报表查询管理</a></li>
							<li><a href="../A_people_look" target="operation"><i class="icon-font">&#xe008;</i>用户管理</a></li>
							<li><a href="#" target="operation"><i class="icon-font">&#xe005;</i>权限管理</a></li>
							<li><a href="#" target="operation"><i class="icon-font">&#xe005;</i>角色管理</a></li>
