...
/**
 * Servlet implementation class A_updateuser
 */
@WebServlet("/A_updateuser")
public class A_updateuser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(res=true) {
			...
			out.print("<script language='javascript'>alert('保存成功');window.location.href='A_people_look';</script>");
		}
		else {
			out.print("<script language='javascript'>alert('保存成功');window.location.href='A_people_look';</script>");
		}
